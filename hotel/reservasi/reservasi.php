        ...
        <table border="1">
            ...
            while($r=mysqli_fetch_array($data)){
                ...
                <tr class="tableData">
                    ...
                    <td>
                        <a href="action-accept-reservasi.php?idrsv=<?php echo $r['id_reservasi'];?>&action=accept" class="ResrvBtnAcpt">Accept</a>
                        <a href="action-accept-reservasi.php?idrsv=<?php echo $r['id_reservasi'];?>&action=decline" class="ResrvBtnDecline">Decline</a>
                    </td>
                </tr>
                <?php
            }
